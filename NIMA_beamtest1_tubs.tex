...
All hodoscopes are also connected via $\sim$2x gain amplifier channels that allows signal splitting. H1 and H3 share the same FADC channel with latter signal being delayed by 200ns. H2 is connected to the last remaining channel of the FADC.
