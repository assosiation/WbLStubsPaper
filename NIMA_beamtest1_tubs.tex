...
The resulting energy depositions are listed in Table~\ref{tab:EnergyDepositionInSamples}. The difference between the two methods is taken as the uncertainty for the values obtained (summed as square root of the sum of the squares with the RMS of the mean). The converted into the PE/MeV light yield is shown in Figure~\ref{fig:tub1signalInPEperMeV} for the T1 and in Figure~\ref{fig:tub1signalInPEperMeV} for the T2.
