...
%\subsubsection{Teflon Light Yield}
%\label{teflonlight}
%As Cerenkov light occurs in the tefon walls of the T1, this contribution has been astimated using the empty T1 tub with the cosmic muons.
...
\bibitem{LYscintanddirection} C. Aberle, A. Elagin, H. J. Frisch, M. Wetstein, L. Winslow, `Measuring Directionality in Double-Beta Decay and Neutrino Interactions with Kiloton-Scale Scintillation Detectors', arXiv:1307.5813 [physics.ins-det]
