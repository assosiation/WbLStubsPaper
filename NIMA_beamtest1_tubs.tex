...
We see that the PE/MeV light yield is the same for LS at proton energies of 2GeV and 475MeV on both tubs, indicating that the Cerenkov ligh contribution is negligible for LS. It is not so for the WbLS, there is a significant LY change between these two energies. However, at 475MeV, there is virtually no Cerenkov light contribution to the total LY, thus, can use the data at this energy for LS to WbLS comparison and for obtaining the LY of the scintillator components of the WbLS.
